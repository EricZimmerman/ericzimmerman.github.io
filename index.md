...
| MFTECmd |[1.0.0.0](https://f001.backblazeb2.com/file/EricZimmermanTools/MFTECmd.zip) &vert; [1.0.0.0](https://f001.backblazeb2.com/file/EricZimmermanTools/net6/MFTECmd.zip) | $MFT, $Boot, $J, $SDS, and $LogFile (coming soon) parser. Handles locked files
